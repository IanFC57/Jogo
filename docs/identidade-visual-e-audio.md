...
- A tela de encerramento deve manter apenas três ações de UI: `Jogar novamente`, `Menu inicial` e `Sair do jogo`. Não adicione título ou subtítulo por TextMeshPro nessa cena; o texto atmosférico válido é o que já está incorporado na imagem de fundo.
